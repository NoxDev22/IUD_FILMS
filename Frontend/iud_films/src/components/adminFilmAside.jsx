      ...
      <ul className="aside_list">
        ...
        <Link to={"estadisticas"}>
          ...
          >
            ...
            >
              <g
                fill={`${activeLi === "analiticas" ? "#ffb4aa" : "#f9f5ebb0"}`}
              >
                <path
                  fillRule="evenodd"
        ...
        <Link to={"/"}>
          <li
            className={`aside_listLi ${activeLi === "cerrar" ? "activeLi" : ""}`}
            onClick={() => setActiveLi("cerrar")}
          >
            <Back />
            <p className="aside_listText">Cerrar Sesión</p>
          </li>
        </Link>
      </ul>
